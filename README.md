...
Explorer et comprendre les données disponibles : clients, ventes, produits et paiements.
Nettoyer et préparer les données pour garantir des analyses fiables.
Calculer les KPIs Retail essentiels : chiffre d’affaires total, évolution mensuelle, meilleurs jours, méthodes de paiement.
...
Transformer les résultats en insights business et recommandations actionnables.
Documenter et organiser le projet dans GitHub pour un livrable professionnel et reproductible.
